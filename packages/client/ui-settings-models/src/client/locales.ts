...
export const en = {
  ...
  thinkingLevels: 'Available thinking levels',
  thinkingWire: 'Wire spelling',
  thinkingLevelHint: 'Enable a level and give its wire spelling; Off with no value keeps thinking disabled.',
  ...
  thinkingLevelNeedsOne: 'Enable at least one level besides Off.',
  thinkingLevelWireRequired: 'Each enabled level needs a wire spelling (Off may stay empty).',
  thinkingLevelInvalid: 'Thinking settings must be Off or a level list.',
  thinkingLevelUnknown: 'Unknown thinking level.',
  noThinkingLevels: 'No thinking',
  modelModalities: 'Input modalities',
  modalityHint: 'An undeclared row follows the provider default, shown here as Text. Clearing every box stores no claim.',
  'modality.text': 'Text',
  'modality.image': 'Image',
  modelModalitiesInvalid: 'Input modalities must be text, image, or both.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  thinkingModel: '思考型模型',
  thinkingLevels: '可用思考强度',
  thinkingWire: '线上拼写',
  thinkingLevelHint: '勾选等级并填写线上拼写；Off 留空表示关闭思考。',
  'thinkingLevel.off': '关闭',
  'thinkingLevel.minimal': '最低',
  'thinkingLevel.low': '低',
  'thinkingLevel.medium': '中',
  'thinkingLevel.high': '高',
  'thinkingLevel.xhigh': '极高',
  'thinkingLevel.max': '最高',
  thinkingLevelNeedsOne: '至少启用一个除 Off 外的等级。',
  thinkingLevelWireRequired: '每个启用的等级都要填写线上拼写（Off 可留空）。',
  thinkingLevelInvalid: '思考设置必须是关闭或等级列表。',
  thinkingLevelUnknown: '未知的思考等级。',
  noThinkingLevels: '无思考',
  modelModalities: '输入模态',
  modalityHint: '未声明的行按提供方默认显示为「文本」；全部取消勾选即不声明。',
  'modality.text': '文本',
  'modality.image': '图像',
  modelModalitiesInvalid: '输入模态只能是文本、图像或两者。',
  fetchModels: '获取可用模型',
  fetching: '正在询问提供方\u2026',
